// ThePlanetForgeONSTEROIDS.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_THEPLANETFORGEONSTEROIDS, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_THEPLANETFORGEONSTEROIDS));
